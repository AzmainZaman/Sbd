...
| Layer | Choice | Reason |
|---|---|---|
| Framework | **Next.js (latest stable)** via `create-next-app@latest` | App Router, SSR, file-based routing, future API routes in Phase 2, Vercel-ready |
...
src/middleware.ts                            ← session refresh + route protection matchers
...
### Phase 2J — Deployment + Production QA
...
RESEND_API_KEY
RESEND_FROM_EMAIL                 ← orders@sbd.com.bd
ADMIN_EMAIL
```
